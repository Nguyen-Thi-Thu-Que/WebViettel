    ...
    <nav className="bg-white sticky top-0 z-50 px-4 py-3.5 md:px-8 flex items-center justify-between border-b border-slate-100 shadow-sm">
      ...
      <form onSubmit={handleSearchSubmit} className="hidden md:flex items-center relative max-w-xs w-full mx-4">
        <input
          ...
          className="w-full bg-slate-50 border border-slate-200 rounded-lg py-1.5 pl-4 pr-10 text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:border-primary/50 focus:bg-white transition-colors"
        />
      ...
      <div className="flex items-center space-x-3">
        {/* Notification Icon */}
        <button className="p-2 bg-slate-55 hover:bg-slate-100 border border-slate-200 rounded-lg text-slate-500 hover:text-slate-800 transition-colors relative focus:outline-none">
        ...
        {currentUser ? (
          <div className="flex items-center space-x-3">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-700 text-sm font-semibold group-hover:border-primary/50 transition-colors">
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white border border-slate-200 rounded-lg shadow-md py-1 text-slate-700 divide-y divide-slate-100 animate-fade-in z-50">
                  <div className="px-4 py-2.5">
                    ...
                    <p className="text-xs text-slate-500 truncate">{currentUser.phoneNumber}</p>
                    {/* Mobile Balance */}
